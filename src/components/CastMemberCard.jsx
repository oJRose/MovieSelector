...
export const CastMemberCard = ({castMember}) => {
  ...
  return (
    <div className='bg-yellow-700 text-white flex-none w-[100px] m-2 h-[150px] cursor-pointer rounded-xl relative'>
        <img className="rounded-xl" src={`https://image.tmdb.org/t/p/w300/${castMember.profile_path}`} alt={castMember.title} />
        <div className="bg-black/70 absolute rounded-b-xl bottom-0 left-0 w-full h-[40%] overflow-scroll">
